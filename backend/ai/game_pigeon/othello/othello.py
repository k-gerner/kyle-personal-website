...
from ai.game_pigeon.othello.enums import BoardSpace, BoardType
...
def _debug_board(board: BoardType) -> None:
    """
...
def run(
    ...
    play_move(board, best_move_row, best_move_col, AI_PIECE)
    new_player_locations, new_ai_locations = current_locations(board)
