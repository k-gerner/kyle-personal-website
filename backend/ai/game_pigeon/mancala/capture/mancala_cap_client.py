...
from ai.game_pigeon.mancala.capture.mancala_player import MancalaPlayer
...
from ai.game_pigeon.mancala.capture.constants import POCKETS_PER_SIDE, BOARD_OUTPUT_HEIGHT, PLAYER1_BANK_INDEX, PLAYER2_BANK_INDEX, \
	SIDE_INDENT_STR, LEFT_SIDE_ARROW, RIGHT_SIDE_ARROW, BOARD_SIZE
from ai.game_pigeon.mancala.capture.mancala_cap_strategy import MancalaStrategy
